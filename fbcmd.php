...
////////////////////////////////////////////////////////////////////////////////
  ...
  //1 $GLOBALS['facebook_config']['debug'] = $fbcmdPrefs['facebook_debug'];
...
////////////////////////////////////////////////////////////////////////////////
  ...
  AddCommand('OBJ',       'display facebook object');//2
  ...
  AddCommand('REFRESH',   'refresh the references cache');//2
  AddCommand('RESET',     '<no parameters>~Reset any authorization codes set by AUTH');
  AddCommand('RESOLVE',   'resolve'); //2
...
////////////////////////////////////////////////////////////////////////////////
  ...
  if ($fbcmdAs) {
    ...
    $newtoken = '';
    if (Resolve($fbcmdAsArg,true,true,'accounts')) {
      try {
...
////////////////////////////////////////////////////////////////////////////////  
  ...
  if ($fbcmdCommand == 'ALIAS') {
    ...
    if (ParamCount() == 0) {
      ...
      if (Resolve($fbcmdParams[2],true,true,'accounts,friends,likes,friendlists,groups,albums')) {
...
////////////////////////////////////////////////////////////////////////////////
  ...
  if ($fbcmdCommand == 'REFRESH') {
    ValidateParamCount(0);
    BuildRefCache(1);
    SaveDataFile('cache_refs','cachefile',$fbcmdRefCache);
  }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  if ($fbcmdCommand == 'RESOLVE') {
    ValidateParamCount(1);
    if (Resolve($fbcmdParams[1],true,true,'accounts,friends,likes,friendlists,groups,albums')) {
...
////////////////////////////////////////////////////////////////////////////////
  ...
  function Resolve($matchme, $exitOnFalse = true, $allowAlias = true, $types = 'accounts,friends,likes') { //FlistMatch ($flistItem,$isPrefixed,$dataArray,$keyId,$keyMatch,$allowMultipleMatches = true, $forceExactMatch = false) {
    global $fbcmdAlias;
    global $resolvedId;
    global $resolvedText;
    global $fbcmdLast;
